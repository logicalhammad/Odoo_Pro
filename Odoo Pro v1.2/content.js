				...
				if (parentTargetElement) {
					...
					if ((allData[subjectName] <= 6 && b != 2) || (b == 2 && allData[subjectName] <= 4)) {
						targetElement.setAttribute("style", `
							width: max-content; border: 1px solid #43a943; border-radius: 5px; padding: 2px 6px; color: green; font-weight: 500; background: #d1ffd1; text-decoration: none !important;
						`);
					}
					else if ((allData[subjectName] <= 9 && b != 2) || (b == 2 && allData[subjectName] <= 6)) {
						targetElement.setAttribute("style", `
							width: max-content; border: 1px solid #a97743; border-radius: 5px; padding: 2px 6px; color: #d36c03; font-weight: 500; background: #ffe0d1; text-decoration: none !important;
						`);
					}
					else {
						targetElement.setAttribute("style", `
							width: max-content; border: 1px solid #a94343; border-radius: 5px; padding: 2px 6px; color: #d30303; font-weight: 500; background: #ffd1d1; text-decoration: none !important;
						`);
					}
				} else {
					console.warn(
