...
window.onload = async () => {
	...
	if (logoImage.src == "https://odoo.cust.edu.pk/odoocms_assets/static/2/logo_org.png") {
		// console.log("Image Already Good: ", logoImage.src);
	} else {
		console.log("Setting Image SRC, original: ", logoImage.src);
		logoImage.src = "https://odoo.cust.edu.pk/odoocms_assets/static/2/logo_org.png";
	}
